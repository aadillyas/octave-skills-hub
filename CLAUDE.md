# Octave Skills Hub — CLAUDE.md

This file gives Claude Code instant project context. Read this before making any changes.
...
An internal web app for the Octave team to discover, share, and AI-match Claude skills (.md files). Live at Vercel (frontend) + Railway (backend).
...
│   ├── .env             # GEMINI_API_KEY, ADMIN_PASSWORD, PORT
...
- Railway filesystem is ephemeral — uploaded files and SQLite DB reset on redeploy. Run `node scripts/backup.js` before pushing if skills have been uploaded
